...
/**
 * SETUP-MWS
 * This file adds functions to the SETUP-MWS Theme.
 *
 * @package SETUP-MWS
 * @author  Mark Corpuz
 * @license GPL-2.0+
...
function setupbasic_localization_setup(){
	load_child_theme_textdomain( 'setup-mws', get_stylesheet_directory() . '/languages' );
}
...
define( 'CHILD_THEME_NAME', 'SETUP-MWS' );
define( 'CHILD_THEME_URL', 'http://model.basestructure.com/setup-mws' );
